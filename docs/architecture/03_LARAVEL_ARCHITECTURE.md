...
app/
  Models/
    Membership/        MembershipApplication.php, Membership.php (member record), MembershipTerm.php, MembershipPlan.php, MembershipCategory.php, ...
    Promotions/         (deferred — future marketing promotions only; not part of the introductory free period)
